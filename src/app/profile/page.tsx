...
const profileCopy = {
  ...
  uk: {
    ...
    exportDataDesc: 'Завантажити всі свої дані у форматі JSON.',
    exportDataAction: 'Завантажити дані',
    exportingData: 'Експортування...',
    deleteAccount: 'Видалити акаунт',
    deleteAccountDesc: 'Назавжди видалити всі дані. Цього не можна скасувати.',
    deleteAccountAction: 'Видалити акаунт',
    deleteAccountConfirm: 'Ви впевнені, що хочете видалити свій акаунт?',
    deleteAccountWarning:
      'Всі ваші дані, включаючи словник, прогрес та налаштування будуть назавжди видалені. Цього не можна скасувати.',
    deleteAccountConfirmAction: 'Так, видалити мій акаунт',
